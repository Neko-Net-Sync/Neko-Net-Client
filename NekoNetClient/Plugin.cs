...
using NekoNetClient.UI.Components.Popup;
...
public sealed class Plugin : IDalamudPlugin
{
        ...
        ISigScanner sigScanner)
    {
        ...
        {
            collection.AddSingleton(new WindowSystem("Neko-Net"));
            collection.AddSingleton<FileDialogManager>();
            collection.AddSingleton(new Dalamud.Localization("Neko-Net.Localization.", "", useEmbedded: true));
            collection.AddSingleton<MultiHubManager>(s => new MultiHubManager(
                s.GetRequiredService<ILogger<MultiHubManager>>(),
            ...
            collection.AddSingleton<SyncFacadeEventLogger>();
            collection.AddSingleton<SyncFacadeOrchestrator>();
            ...
            collection.AddSingleton((s) =>
            {
                ...
                httpClient.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("Neko-Net", ver!.Major + "." + ver!.Minor + "." + ver!.Build));
                return httpClient;
            });
            ...
            collection.AddScoped((s) => new CommandManagerService(commandManager, s.GetRequiredService<PerformanceCollectorService>(),
                ...
                s.GetRequiredService<MareMediator>(), s.GetRequiredService<MareConfigService>(), s.GetRequiredService<ISyncFacade>()));
            collection.AddScoped((s) => new UiSharedService(s.GetRequiredService<ILogger<UiSharedService>>(), s.GetRequiredService<IpcManager>(), s.GetRequiredService<ApiController>(),
                ...
                s.GetRequiredService<MareMediator>(), s.GetRequiredService<ISyncFacade>()));
