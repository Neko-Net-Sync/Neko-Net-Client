...
public class DrawFolderTag : DrawFolderBase
{
    ...
    public DrawFolderTag(string id, IImmutableList<DrawUserPair> drawPairs, IImmutableList<Pair> allPairs,
        TagHandler tagHandler, IApiActionRouter apiController, SelectPairForTagUi selectPairForTagUi, UiSharedService uiSharedService)
    ...
    protected override void DrawMenu(float menuWidth)
    {
        ...
        {
            // Ensure selection UI uses the same TagHandler scope as this folder
            _selectPairForTagUi.Open(_id, _tagHandler);
        }
    ...
    {
        _ = _api.SetBulkPermissions(new(availablePairs
